...
<div class="deep">
                <div class="tit_bdy1">매입 지급 등록</div>
...
<!-- Modal -->
			<form id="sale_edit" name="sale_edit" action="purchase_collection_register.php" method="post" onsubmit="return form_check();">
              ...
              <div class="modal-dialog" style="width: auto;" >
				...
				<!-- Modal header-->
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">매입 지급 관리</h4>
                  </div>
				  <!-- END Modal header-->
				  ...
				  <input type="hidden" id="origin_price" name="origin_price" value="">
								...
								<div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line"><strong>총 지급계</strong>
                            ...
                            <div class="table-responsive col-sm-12" id="no-more-tables">
                                <table class='table table-striped table-bordered' >
                                    ...
                                    <tbody id="add_collection">
                                     <div>
								  <td colspan="7" id='explain_list_collection'>※ 지급액을 추가해 주세요.</td>
								  </div>
                                    </tbody>
									<td colspan="7" ><center><button type="button" onclick="collection_write()" class="btn btn-primary m-t-15 waves-effect">추가</button></center></td>
                                </table>
                           </div>
                        </div>
									<!--END content2-->   
			...
			function deleteDiv2(index_num,sp_num,price) {
				...
				if (confirm("정말 삭제하시겠습니까??") == true){    //확인
					...
					if (window.XMLHttpRequest)  {// code for IE7+, Firefox, Chrome, Opera, Safari
						   ...
						   xmlhttp.open("POST","purchase_pay_ajax.php",true);
