...
<!-- Modal -->
			<form id="purchase_edit" name="purchase_edit" action="purchase_edit_register.php" method="post" onsubmit="return form_check();">
              ...
              <div class="modal-dialog" style="width: auto;" >
				...
				<!-- Modal header-->
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">매입 수정</h4>
                  </div>
				  <!-- END Modal header-->
			...
			function deleteDiv_sort(i,index_num,sort,stock_index) {
				...
				if (confirm("정말 삭제하시겠습니까??") == true){    //확인
				        ...
				        $("#joint_tr"+index_num).remove();
						   ...
						   xmlhttp.open("POST","purchase_ajax.php",true);
   ...
   xmlhttp.open("POST","purchase_ajax.php",true);
   xmlhttp2.open("POST","purchase_ajax.php",true);
   xmlhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
