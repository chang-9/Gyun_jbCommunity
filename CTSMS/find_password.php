...
<body class="login-page" >
    <div class="login-box">
        ...
        <div class="card" style="background:rgba(255, 255, 255, .15)">
            <div class="body">
				<form name="check_id" action="check_password.php"  method="POST">
					...
					<div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" style="background-color: rgba(0, 0, 0, 0);" class="form-control" id="id" name="id" placeholder="아이디를 입력해주세요."  required>
                        </div>
                    </div>
                    ...
                    <button id="other" class="btn btn-block btn-lg bg-black waves-effect" type="submit" value="확인">Find Password</button>
