	...
	<script>
      ...
      echartBar.setOption({
        ...
        series: [{
          ...
          name: 'purchases',
          type: 'bar',
          data: [6.2, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 3],
          markPoint: {
            data: [{
              name: 'Max',
              type: 'max'
      ...
      echartRadar.setOption({
        ...
        series: [{
          ...
          type: 'radar',
          data: [{
            value: [43000, 10000, 28000, 35000, 50000, 19000],
            name: 'Allocated Budget'
          }, {
            value: [50000, 14000, 28000, 31000, 42000, 21000],
        ...
        series: [{
          ...
          tooltip: {
            ...
            formatter: function(params) {
                return '<b>'+params.seriesName + '</b><br/> Height:' + params.value[0] + 'cm <br/>Weight:  ' + params.value[1] + 'kg ';
            }
          },
          data: [
            [161.2, 51.6],
	...
	/*echartMiniPie*/
      ...
      echartMap.setOption({
        title: {
          ...
          subtext: 'from United Nations, Total population, both sexes combined, as of 1 July',
          x: 'center',
          y: 'top'
        },
        tooltip: {
          ...
          formatter: function(params) {
			...
			<!--function to apply commas after each 3 values, replace unwanted characters and append the thousands part-->
